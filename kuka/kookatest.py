...
# lengths of links in yaw, shoulder, elbow, wrist
LINK_LEN = [0.03, 0.45, 0.3, 0.1]

# angle values in yaw, shoulder, and elbow in the robot's home position
...
class kookabot:
    ...
    def stir(self):
        ...
        for i in range(self.points):
            self.x_stir[i] = center_x + self.stir_radius*math.cos(2*math.pi*i/self.points)
            self.y_stir[i] = center_y + self.stir_radius*math.sin(2*math.pi*i/self.points)
